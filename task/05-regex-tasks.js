...
function getRegexForIPv4() {
    // return /^([0-9]|[0][0-9]|[00][0-9]|[1-9][0-9]|0[0-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])[.]([0-9]|[0][0-9]|[00][0-9]|[1-9][0-9]|0[0-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])[.]([0-9]|[0][0-9]|[00][0-9]|[1-9][0-9]|0[0-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])[.]([0-9]|[0][0-9]|[00][0-9]|[1-9][0-9]|0[0-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]){0,3}/i;
    throw new Error('Not implemented');
}
...
function getRegexForSSN() {
    return /(?!000)\d{3}-(?!00)\d{2}-(?!0000)\d{4}/i;
}
